import { View, TextInput, Pressable, FlatList, Text, TouchableWithoutFeedback, Keyboard } from "react-native";
      ...
      <Pressable onPress={Keyboard.dismiss} className='flex-1'>
        ...
        <View className='px-4 pt-4 pb-3'>
          <View className='w-full bg-brown-400 py-2 px-4 rounded-full flex-row items-center'>
            ...
            />
            <Pressable hitSlop={10} onPress={() => {setSearchInput(""); setSearchWord("")}}>
              <PlusCircleIcon 
                color="black"
                size={20}
                style={{
